    ...
    (() => {
        ...
        function initTechAvailability() {
            ...
            function nowBucketId() {
                return String(Math.floor(Date.now() / (BUCKET_MINUTES * 60 * 1e3)));
            }
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            if (targetBlockElement) {
                ...
                if (window.innerWidth < 768) headerItemHeight = 56; else headerItemHeight = 96;
                if (noHeader) {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".portfolio-img__slider")) new swiper_core_Swiper(".portfolio-img__slider", {
...
***************************************************************************** */
        ...
        function randomShake() {
            ...
            const nextTime = Math.random() * (3e4 - 2e4) + 2e4;
